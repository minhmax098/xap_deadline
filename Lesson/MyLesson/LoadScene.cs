   ...
   public class LoadScene : MonoBehaviour
    {
        ...
        async void UpdateLessonsPanel(bool isRenewLessonPanel)
        {
            try
            {
                ...
                string URL = String.Format(APIUrlConfig.GET_MY_LESSONS, searchValueString, offset, limit);
                ...
                else
                {
                    ...
                    Toast.ShowCommonToast(lessonResponse.message, APIUrlConfig.SERVER_ERROR_RESPONSE_CODE);
                }                
            } 
            catch (Exception e)
            {
